<template>
  <div>
    ...
    <div class="body blogshader">
      ...
      <el-row :gutter="10">
        <el-col :xs="24" :lg="12">
          <div class="new-group blogshader">
        ...
        <el-col :xs="24" :lg="12">
          <div class="perm-list blogshader">
            <el-row>
              <el-col
      ...
      <el-row :gutter="10">
        ...
        <el-col :span="8">
          <div class="body blogshader">
            <el-button @click="setUserToGroup()" type="success"
              >保存分配</el-button
            >
          </div>
        </el-col>
...
export default {
  ...
  methods: {
    ...
    setUserToGroup() {
      ...
      axios({
        method: "post",
        url: "http://127.0.0.1:9000/api/gf-group/",
        data: Qs.stringify({
    ...
    //用户列表
    getUserList() {
      axios.get("http://127.0.0.1:9000/api/gf-userlist/").then((res) => {
        console.log(res.data);
    ...
    //获取所有用户组
    getAllUserGroup() {
      axios.get("http://127.0.0.1:9000/api/gf-group/").then((res) => {
        console.log(res);
    ...
    saveNewGroup() {
      ...
      let checkType = false;
      let perm_list = [];
      this.new_group.checkList.forEach((element) => {
        if (element.checkList.length > 0) {
          checkType = true;
          let perm_item = {
            content_type: element.content_type,
            perm_methods: element.checkList,
          };
